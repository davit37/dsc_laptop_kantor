...
<head>
	...
	<title>DESAINCUB3 | Dashboard</title>
	...
	<div class="wrapper">
		...
		<header class="main-header">
			...
			<a href="index2.html" class="logo">
				...
				<span class="logo-mini"><b>D</b>Cub3</span>
				<!-- logo for regular state and mobile devices -->
				<span class="logo-lg"><b>Design</b>Cub3</span>
			</a>
			...
			<nav class="navbar navbar-static-top">
				...
				<div class="navbar-custom-menu">
					...
					<li><a href='<?php echo site_url()?>' target='_blank'><i class='fa fa-eye'></i> View Web</a></li>
